...
print()
print('风险描述测试:')
print(get_risk_description(0.95))
print(get_risk_description(0.65))
print(get_risk_description(0.35))
print(get_risk_description(0.10))
